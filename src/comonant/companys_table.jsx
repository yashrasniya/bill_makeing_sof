        ...
        <div className={'companys_header_raper'}>
            ...
            <div className={'pop-up-box'} id={'new_company_box'}>
                ...
                <div className={'pop-up-box_inputs'}>
                    <div className={'form_box'} style={{flexBasis:'48%'}}>Customer Name
                        <input id="name" value={company_data["name"]}
                               onChange={(e)=>set_company_data({...company_data,[e.target.id]:e.target.value})} /></div>
                    <div className={'form_box'} style={{flexBasis:'48%'}} >Customer Address
                        <input id="address" value={company_data["address"]}
                               onChange={(e)=>set_company_data({...company_data,[e.target.id]:e.target.value})} /></div>
                    <div className={'form_box' } style={{flexBasis:'48%'}}>Customer GST Number
                    ...
                    <div className={'form_box'} style={{flexBasis:'33%'}}>Phone Number
                        <input id="phone_number"   value={company_data["phone_number"]}
                               onChange={(e)=>set_company_data({...company_data,[e.target.id]:e.target.value})} />
                   </div>
                </div>
